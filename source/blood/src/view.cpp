...
void viewProcessSprites(int32_t cX, int32_t cY, int32_t cZ, int32_t cA, int32_t smooth)
{
    ...
    for (int nTSprite = spritesortcnt-1; nTSprite >= 0; nTSprite--)
    {
        ...
        if (!VanillaMode() && (pTSprite->statnum == kStatDude))
        {
            ...
            if ((numplayers > 1) && IsPlayerSprite(pTSprite) && gProfile[pTSprite->type-kDudePlayer1].nModel) // replace player caleb sprite with cultist sprite
            {
                bReplacedPlayerTile = 1;
                switch (nTile)
                {
                    // 3840 L IMPACT
                    case 3840: nTile = pTSprite->picnum = 2865; break;
                    // 3845 L LIFT
                    case 3845: nTile = pTSprite->picnum = 2870; break;
                    // 3850 MID
                    case 3850: nTile = pTSprite->picnum = 2875; break;
                    // 3855 R IMPACT
                    case 3855: nTile = pTSprite->picnum = 2880; break;
                    // 3860 R LIFT
                    case 3860: nTile = pTSprite->picnum = 2885; break;
                    // 3865 MID
                    case 3865: nTile = pTSprite->picnum = 2860; break;
                    // 3870 STAND
                    case 3870: nTile = pTSprite->picnum = 2825; break;
                    // 3875 LEANED
                    case 3875: nTile = pTSprite->picnum = 2925; break;
                    // 3880-4 SHOT AND FALL
                    case 3880: nTile = pTSprite->picnum = 2930; break;
                    // 3885-6 DEAD FLAT
                    case 3881: nTile = pTSprite->picnum = 2931; break;
                    case 3882: nTile = pTSprite->picnum = 2932; break;
                    case 3883: nTile = pTSprite->picnum = 2933; break;
                    case 3884: nTile = pTSprite->picnum = 2934; break;
                    case 3885: nTile = pTSprite->picnum = 2935; break;
                    case 3886: nTile = pTSprite->picnum = 2936; break;
                    // 3887 SWIM L IMPACT
                    case 3887: nTile = pTSprite->picnum = 3241; break;
                    // 3892 SWIM L LIFT
                    case 3892: nTile = pTSprite->picnum = 3241; break;
                    // 3897 MID
                    case 3897: nTile = pTSprite->picnum = 3246; break;
                    // 3902 SWIM R IMPACT
                    case 3902: nTile = pTSprite->picnum = 3246; break;
                    // 3907 SWIM R LIFT
                    case 3907: nTile = pTSprite->picnum = 3251; break;
                    // 3912 SWIM MID
                    case 3912: nTile = pTSprite->picnum = 3256; break;
                    // 3917 PRONE R1
                    case 3917: nTile = pTSprite->picnum = 3375; break;
                    // 3922 PRONE R2
                    case 3922: nTile = pTSprite->picnum = 3380; break;
                    // 3927 PRONE L1
                    case 3927: nTile = pTSprite->picnum = 3385; break;
                    // 3932 PRONE L2
                    case 3932: nTile = pTSprite->picnum = 3390; break;
                    // 3937-48 FINISH HIM DEATH SEQ
                    case 3937: nTile = pTSprite->picnum = 2930; break;
                    case 3938: nTile = pTSprite->picnum = 2931; break;
                    case 3939: nTile = pTSprite->picnum = 2932; break;
                    case 3940: nTile = pTSprite->picnum = 2932; break;
                    case 3941: nTile = pTSprite->picnum = 2932; break;
                    case 3942: nTile = pTSprite->picnum = 2933; break;
                    case 3943: nTile = pTSprite->picnum = 2933; break;
                    case 3944: nTile = pTSprite->picnum = 2933; break;
                    case 3945: nTile = pTSprite->picnum = 2934; break;
                    case 3946: nTile = pTSprite->picnum = 2935; break;
                    case 3947: nTile = pTSprite->picnum = 2936; break;
                    case 3948: nTile = pTSprite->picnum = 2937; break;
                    // 3949-53 FINISH HIM HEADLESS SEQ
                    case 3949: nTile = pTSprite->picnum = 2933; break;
                    case 3950: nTile = pTSprite->picnum = 2934; break;
                    case 3951: nTile = pTSprite->picnum = 2935; break;
                    case 3952: nTile = pTSprite->picnum = 2936; break;
                    case 3953: nTile = pTSprite->picnum = 2937; break;
                    // 3959 UNUSED JUMP
                    case 3959: nTile = pTSprite->picnum = 2895; break;
                    // 3964-65 FINISH HIM KNEEL LOOP
                    case 3964: nTile = pTSprite->picnum = 2932; break;
                    case 3965: nTile = pTSprite->picnum = 2933; break;
                    default: bReplacedPlayerTile = 0; break;
                }
                if (bReplacedPlayerTile && (gGameOptions.nGameType == kGameTypeTeams) && !(gGameOptions.uNetGameFlags&kNetGameFlagNoTeamColors)) // force correct palette is for teams color mode
                {
                    if (pTSprite->pal == 2)
                        pTSprite->pal = 12;
                    else if (pTSprite->pal == 10)
                        pTSprite->pal = 11;
                }
            }
