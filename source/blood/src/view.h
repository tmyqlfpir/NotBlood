...
void viewSetMessageColor(const char *pMessage, const int nPal = 0, const MESSAGE_PRIORITY nPriority = MESSAGE_PRIORITY_NORMAL, const int nPal1 = 0, const int nPal2 = 0);
